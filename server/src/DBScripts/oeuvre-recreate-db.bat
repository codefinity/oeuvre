...
ECHO Dropping Tables and Schema
sqlcmd -S DESKTOP-6DRE2VL -d %databaseName% -i ..\Modules\ContentCreation\DBScripts\oeuvre-contentcreation-drop-db-tables-and-views-and-schema.sql

ECHO Creating Schema
sqlcmd -S DESKTOP-6DRE2VL -d %databaseName% -i ..\Modules\ContentCreation\DBScripts\oeuvre-contentcreation-create-schema.sql

ECHO Creating Tables
sqlcmd -S DESKTOP-6DRE2VL -d %databaseName% -i ..\Modules\ContentCreation\DBScripts\oeuvre-contentcreation-create-db-tables.sql

ECHO Creating Views
sqlcmd -S DESKTOP-6DRE2VL -d %databaseName% -i ..\Modules\ContentCreation\DBScripts\oeuvre-contentcreation-create-views.sql

ECHO Adding Seed Data
sqlcmd -S DESKTOP-6DRE2VL -d %databaseName% -i ..\Modules\ContentCreation\DBScripts\oeuvre-contentcreation-add-seed-data.sql
