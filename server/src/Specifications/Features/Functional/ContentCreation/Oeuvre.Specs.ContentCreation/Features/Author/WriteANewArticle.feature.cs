...
namespace Oeuvre.Specs.ContentCreation.Features.Author
{
    ...
    public partial class WriteArticleFeature : object, Xunit.IClassFixture<WriteArticleFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "WriteANewArticle.feature"
#line hidden
        
        public WriteArticleFeature(WriteArticleFeature.FixtureData fixtureData, Oeuvre_Specs_ContentCreation_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "WriteArticle", "\tUsers should be able to write articles", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
#line 6
 testRunner.When("I wish to write an article", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 7
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                WriteArticleFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                WriteArticleFeature.FeatureTearDown();
            }
        }
    }
}
